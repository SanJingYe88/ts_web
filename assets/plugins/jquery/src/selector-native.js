 ...
 */
    ...
    let hasDuplicate; let sortInput
    const sortStable = jQuery.expando.split('').sort(sortOrder).join('') === jQuery.expando
    ...
    jQuery.extend(jQuery.find, {
        ...
        attr (elem, name) {
            ...
            const value = fn && hasOwn.call(jQuery.expr.attrHandle, name.toLowerCase())
